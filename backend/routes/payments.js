...
// @desc    Verify OTP with Razorpay (server-side)
// @access  Public (but do NOT expose secret keys on client)
router.post('/verify-otp', async (req, res) => {
  try {
    const { otp, payment_id, token_id, contact } = req.body;
    ...
    console.error('OTP verify unexpected error:', error.message || error);
