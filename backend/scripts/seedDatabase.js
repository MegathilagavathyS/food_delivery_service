...
const mockRestaurants = [
  // Chennai Restaurants
  {
    ...
    image: 'C:\KEC academics\fullstack final\FDS\public\images\restaurants\saravana.png',
...
// scripts/updateRestaurantImages.js
const mongoose = require('mongoose');
const Restaurant = require('../models/Restaurant');
require('dotenv').config();
...
async function run() {
  await mongoose.connect(process.env.MONGODB_URI);
  await Restaurant.updateOne({ id: '1002' }, { $set: { image: '/images/restaurants/1002.jpg' } });
  // add more updates...
